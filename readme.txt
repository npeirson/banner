...
## Project Banner Buoyancy Control and Data Acquisition System
## Created: Summer 2016 by Madeline McMillan and Nate Peirson
...
5) Files and Their Functions


== 1) Overview ==
This software was designed to control the components of an experimental payload loitering system, and to simultaneously collect atmospheric data from a variety of sensors. The entire system is initiated by running init.py.
Not included in this package are the gamma radiation and lightning strike detection hardware, which run independently on additional threads.
Coding by Madeline McMillan and Nate Peirson, with additional contributions from Ramsey Bissex and Michael Bayern. We literally learned Python while writing this system, so it's far from perfect.
